...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/mdenisov/micro/issues/new')}
  `
}

exports.exampleHelp = function () {
  return `Example from https://github.com/mdenisov/micro/tree/master/examples/ ${output.param(
    'example-path',
  )}`
}
...
For example:
  ${chalk.cyan(program.name)} ${chalk.green('my-frontend')}
  ${chalk.cyan(program.name)} ${chalk.cyan(
    '--example basic',
  )} ${chalk.green('my-basic-app')}
...
exports.start = function (projectName) {
  ...
  ${chalk.green('https://github.com/mdenisov/micro/issues')}
`
}
