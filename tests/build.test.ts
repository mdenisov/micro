...
describe('build', () => {
  ...
  it('should compile files with a custom .babelrc', () => {
    utils.setupStageWithFixture(stageName, 'build-with-babelrc')
  ...
  it('should compile files with a custom frontend.config.js', () => {
    utils.setupStageWithFixture(stageName, 'build-with-custom-config')
